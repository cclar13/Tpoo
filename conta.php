...
<div class="container">
    <div class="row" style="margin-top:5%">
        <div class="col-md-4">
            <div class="card cardSaldo">
                <img src="./img/saldo.png" class=" img-fluid" width="50%" alt="...">
                <div class="card-body">
        ...
        <div class="col-md-4">
            <div class="card cardDepositar">
                <img src="./img/depositar.png" class=" img-fluid" width="50%"  alt="...">
                <div class="card-body">
